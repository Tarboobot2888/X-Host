...
className={fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${   scrolled    ? "bg-gradient-to-b from-slate-900/95 via-slate-900/95 to-slate-950/95 backdrop-blur-xl border-b border-slate-800/40 shadow-2xl"    : "bg-gradient-to-b from-slate-900/80 via-slate-900/80 to-slate-950/80 backdrop-blur-lg"   }}
>
            ...
            >  
              ...
              >  
                <div className="flex items-center gap-2">  
                  <div className="text-blue-500/60 group-hover:text-blue-400 transition-colors duration-300">  
                    {item.icon}  
                  </div>  
